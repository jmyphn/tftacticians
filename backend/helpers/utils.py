...
""",
    "Twisted Fate": """
Twisted Fate is an infamous cardsharp and swindler who has gambled and charmed his way across much of the known world, earning the enmity and admiration of the rich and foolish alike. He rarely takes things seriously, greeting each day with a mocking smile and an insouciant swagger. In every possible way, Twisted Fate always has an ace up his sleeve. guinsoos rageblade: Crucial for ramp-up auto-attackers (Aphelios, Kog'Maw). Top-tier if fights last long enough. guinsoos rageblade: Crucial for ramp-up auto-attackers (Aphelios, Kog'Maw). Top-tier if fights last long enough. hextech gunblade: Heals the lowest HP ally for % of damage dealt. Best if you have infinite-scaling AP (e.g. Archangels). Stacks AP each auto; double Rageblade + healing can ‘go infinite.’
""",
    "Urgot": """
Once a powerful Noxian headsman, Urgot was betrayed by the empire for which he had killed so many. Bound in iron chains, he was forced to learn the true meaning of strength in the Dredge—a prison mine deep beneath Zaun. Emerging in a disaster that spread chaos throughout the city, he now casts an imposing shadow over its criminal underworld. Raising his victims on the very chains that once enslaved him, he will purge his new home of the unworthy, making it a crucible of pain. guinsoos rageblade: Crucial for ramp-up auto-attackers (Aphelios, Kog'Maw). Top-tier if fights last long enough. infinity edge: No review available last whisper: Armor shred for AD teams. Often overshadowed if you run Evenshroud, but still strong for multi-target. Hybrid DPS/spell champion; gains from attack-speed stacking + crit + shred.
""",
    "Varus": """
One of the ancient darkin, Varus was a deadly killer who loved to torment his foes, driving them almost to insanity before delivering the killing arrow. He was imprisoned at the end of the Great Darkin War, but escaped centuries later in the remade flesh of two Ionian hunters—they had unwittingly released him, cursed to bear the bow containing his bound essence. Varus now seeks out those who trapped him, in order to enact his brutal vengeance, but the mortal souls within still resist him every step of the way. spear of shojin: Vital for AD spells (MF, Xayah). Also flexible for big-ability cycles in hybrid comps. rabadons deathcap: Maximizes flat AP. Great if not stacking Archangels or you have enough time to ramp. guardbreaker: No review available Executioner trait provides crit, so raw AP + quick casting is key.
""",
    "Vayne": """
Shauna Vayne is a deadly, remorseless Demacian monster hunter, who has dedicated her life to finding and destroying the demon that murdered her family. Armed with a wrist-mounted crossbow and a heart full of vengeance, she is only truly happy when slaying practitioners or creations of the dark arts, striking from the shadows with a flurry of silver bolts. guinsoos rageblade: Crucial for ramp-up auto-attackers (Aphelios, Kog'Maw). Top-tier if fights last long enough. runaans hurricane: No review available hextech gunblade: Heals the lowest HP ally for % of damage dealt. Best if you have infinite-scaling AP (e.g. Archangels). Slayer synergy; heavy auto-attacks with multi-target via Runaan’s + sustain.
""",
    "Veigar": """
An enthusiastic master of dark sorcery, Veigar has embraced powers that few mortals dare approach. As a free-spirited inhabitant of Bandle City, he longed to push beyond the limitations of yordle magic, and turned instead to arcane texts that had been hidden away for thousands of years. Now a stubborn creature with an endless fascination for the mysteries of the universe, Veigar is often underestimated by others—but even though he believes himself truly evil, he possesses an inner morality that leads some to question his deeper motivations. blue buff: Transforms short-mana champs (Nidalee, Yumi, Veigar) into spam casters. Extremely high-priority tier item. nashors tooth: Attack speed + AP for cast spam (Annie). Often overshadowed by other rod + bow combos. hextech gunblade: Heals the lowest HP ally for % of damage dealt. Best if you have infinite-scaling AP (e.g. Archangels). Short-range AP carry in Techies; spams spells quickly (low mana), deals high damage.
""",
    "Vex": """
In the black heart of the Shadow Isles, a lone yordle trudges through the spectral fog, content in its murky misery. With an endless supply of teen angst and a powerful shadow in tow, Vex lives in her own self-made slice of gloom, far from the revolting cheer of the “normie” world. Though she lacks ambition, she is quick to strike down color and happiness, stopping all would-be interlopers with her magical malaise. blue buff: Transforms short-mana champs (Nidalee, Yumi, Veigar) into spam casters. Extremely high-priority tier item. rabadons deathcap: Maximizes flat AP. Great if not stacking Archangels or you have enough time to ramp. guardbreaker: No review available Executioner trait means built-in crit; needs raw AP + fast casts.
""",
    "Vi": """
Raised on the mean streets of Zaun, Vi is a hotheaded, impulsive, and fearsome woman with very little respect for authority. She has always been a shrewd survivor, both from her youthful troublemaking topside and an unfairly long stint in Stillwater Hold. Now working with the Piltover Enforcers to keep the peace instead of breaking it, she wields mighty hextech gauntlets that can punch through walls—and criminals—with equal ease. steraks gage: Scales with both HP & AD, but underperforms in a set with fewer AD bruisers. Potentially okay on Renekton. bloodthirster: Build on melee AD champs who need a shield + lifesteal (e.g. Zed, Rengar). Less common set-wide. titans resolve: Use on a tank that also deals significant damage | Hybrid stacking item for front-liners who do damage. Usually overshadowed except on strong melee bruisers. Hero-augment bruiser scaling with HP + typical frontliner damage items.
""",
    "Viego": """
Once ruler of a long-lost kingdom, Viego perished over a thousand years ago when his attempt to bring his wife back from the dead triggered the magical catastrophe known as the Ruination. Transformed into a powerful, unliving wraith tortured by an obsessive longing for his centuries-dead queen, Viego now stands as the Ruined King, controlling the deadly Harrowings as he scours Runeterra for anything that might one day restore her, and destroying all in his path as the Black Mist pours endlessly from his cruel, broken heart. edge of night: Removes aggro at low HP. Solid for melee carries (Rengar, Graves) but narrow in this set. jeweled gauntlet: Spell crit item for AP; mandatory unless you have a trait that grants free crit (e.g. Executioner). hand of justice: Adds crit, healing, or raw damage. Often a third item for melee front-liners or short-range DPS. If Techies-based: gets AP from trait, so focus on crit + lifesteal. In Golden Ox builds, replace JG/HoJ with archangels staff or rabadons deathcap.
""",
    "Xayah": """
Deadly and precise, Xayah is a vastayan revolutionary waging a personal war to save her people. She uses her speed, guile, and razor-sharp feather blades to cut down anyone who stands in her way. Xayah fights alongside her partner and lover, Rakan, to protect their dwindling tribe, and restore their race to her vision of its former glory. spear of shojin: Vital for AD spells (MF, Xayah). Also flexible for big-ability cycles in hybrid comps. infinity edge: No review available last whisper: Armor shred for AD teams. Often overshadowed if you run Evenshroud, but still strong for multi-target. Spell-focused AD carry who still needs auto damage; needs mana + crit + shred.
""",
    "Yuumi": """
A magical cat from Bandle City, Yuumi was once the familiar of a yordle enchantress, Norra. When her master mysteriously disappeared, Yuumi became the Keeper of Norra's sentient Book of Thresholds, traveling through portals in its pages to search for her. Yearning for affection, Yuumi seeks friendly companions to partner with on her journey, protecting them with luminous shields and fierce resolve. While Book strives to keep her on task, Yuumi is often drawn to worldly comforts, such as naps and fish. In the end, however, she always returns to her quest to find her friend. blue buff: Transforms short-mana champs (Nidalee, Yumi, Veigar) into spam casters. Extremely high-priority tier item. statikk shiv: Backline lightning + MR shred. Great for hybrid AP boards or quick AoE anti-heal synergy. morellonomicon: Applies Grievous Wounds in AoE. Top choice if your caster can spread damage to many units. Usually leftover items if forced; can poke from range, but not a main carry.
""",
    "Zac": """
Zac is the product of a toxic spill that ran through a chemtech seam and pooled in an isolated cavern deep in Zaun's Sump. Despite such humble origins, Zac has grown from primordial ooze into a thinking being who dwells in the city's pipes, occasionally emerging to help those who cannot help themselves or to rebuild the broken infrastructure of Zaun. ionic spark: Utility tank item that is used with AP-heavy teams | Magic shred around the holder. Needs a stable front line so it doesn't die before applying shred. sunfire cape: Utility tank item for teams needing an anti-heal (wound) effect | Auto-applies Grievous Wounds in a radius. Best with a durable tank that can stand in the thick of battle. protectors vow: Good for tanks that need to cast their first ability as soon as possible Splits into multiple blobs each applying AoE effects; accelerate first cast.
""",
    "Zed": """
Utterly ruthless and without mercy, Zed is the leader of the Order of Shadow, an organization he created with the intent of militarizing Ionia's magical and martial traditions to drive out Noxian invaders. During the war, desperation led him to unlock the secret shadow form—a malevolent spirit magic as dangerous and corrupting as it is powerful. Zed has mastered all of these forbidden techniques to destroy anything he sees as a threat to his nation, or his new order. edge of night: Removes aggro at low HP. Solid for melee carries (Rengar, Graves) but narrow in this set. infinity edge: No review available hand of justice: Adds crit, healing, or raw damage. Often a third item for melee front-liners or short-range DPS. Main melee AD caster at 4-cost; needs strong survival + crit + healing.
""",
    "Zeri": """
A headstrong, spirited young woman from Zaun's working-class, Zeri channels her electric magic to charge herself and her custom-crafted gun. Her volatile power mirrors her emotions, its sparks reflecting her lightning-fast approach to life. Deeply compassionate toward others, Zeri carries the love of her family and her home into every fight. Though her eagerness to help can sometimes backfire, Zeri believes one truth to be certain: stand up for your community, and it will stand up with you. guinsoos rageblade: Crucial for ramp-up auto-attackers (Aphelios, Kog'Maw). Top-tier if fights last long enough. hextech gunblade: Heals the lowest HP ally for % of damage dealt. Best if you have infinite-scaling AP (e.g. Archangels). runaans hurricane: No review available Auto-attack synergy with echo shots; stacking AS + healing + multi-target.
""",
    "Ziggs": """
With a love of big bombs and short fuses, the yordle Ziggs is an explosive force of nature. As an inventor's assistant in Piltover, he was bored by his predictable life and befriended a mad, blue-haired bomber named Jinx. After a wild night on the town, Ziggs took her advice and moved to Zaun, where he now explores his fascinations more freely, terrorizing the chem-barons and regular citizens alike in his never ending quest to blow stuff up. blue buff: Transforms short-mana champs (Nidalee, Yumi, Veigar) into spam casters. Extremely high-priority tier item. morellonomicon: Applies Grievous Wounds in AoE. Top choice if your caster can spread damage to many units. statikk shiv: Backline lightning + MR shred. Great for hybrid AP boards or quick AoE anti-heal synergy. AoE bombard from backline; repeated casts applying utility or anti-heal.
""",
    "Zyra": """
Born in an ancient, sorcerous catastrophe, Zyra is the wrath of nature given form—an alluring hybrid of plant and human, kindling new life with every step. She views the many mortals of Valoran as little more than prey for her seeded progeny, and thinks nothing of slaying them with flurries of deadly spines. Though her true purpose has not been revealed, Zyra wanders the world, indulging her most primal urges to colonize, and strangle all other life from it. spear of shojin: Vital for AD spells (MF, Xayah). Also flexible for big-ability cycles in hybrid comps. morellonomicon: Applies Grievous Wounds in AoE. Top choice if your caster can spread damage to many units. statikk shiv: Backline lightning + MR shred. Great for hybrid AP boards or quick AoE anti-heal synergy. Generally used for CC; repeated casts for stuns or anti-heal.
""",
}
